...
int main(int argc, char* argv[])
{
	...
	char filepath_in[] = "../testResource/bigbuckbunny_480x272.hevc";
#elif TEST_H264
	AVCodecID codec_id = AV_CODEC_ID_H264;
	char filepath_in[] = "../testResource/bigbuckbunny_480x272.h264";
#else
	AVCodecID codec_id = AV_CODEC_ID_MPEG2VIDEO;
	char filepath_in[] = "../testResource/bigbuckbunny_480x272.m2v";
#endif
